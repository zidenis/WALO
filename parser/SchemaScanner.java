...
public class SchemaScanner extends antlr.CharScanner implements SchemaParserTokenTypes, TokenStream
 {
public SchemaScanner(InputStream in) {
	this(new ByteBuffer(in));
}
public SchemaScanner(Reader in) {
	this(new CharBuffer(in));
}
public SchemaScanner(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public SchemaScanner(LexerSharedInputState state) {
	super(state);
...
tryAgain:
	...
	public final void mNUMERICAL_CONST(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if (((LA(1) >= '0' && LA(1) <= '9'))) {
				...
				if ( _cnt1713>=1 ) { break _loop1713; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
	...
	public final void mNAME(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			...
			default:
			{
				if ( _cnt1716>=1 ) { break _loop1716; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
			}
			_cnt1716++;
		} while (true);
